...
- `docs/ai/shared/governor-review-log/`: **closed historical archive** (post-ADR-047) of 17 entries from the Phase 1~5 build-out. New cross-tool review provenance lives in PR description Governor Footer (see ADR 047 D2). See `governor-review-log/README.md` banner for the alias map back to ADR 047 G-slots.
