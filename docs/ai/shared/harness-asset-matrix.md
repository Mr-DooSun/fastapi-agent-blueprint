...
- **Migration risk**: Low. Behaviour-invariance proven by 200 unit tests (93 baseline + 107 added) and three-tier fail-open coverage including the R0-A.1 invariant (importing a shim under `contextlib.suppress(Exception)` MUST NOT raise SystemExit).
