...
- **Error notifications** — optional Slack/Discord webhook alerts from the exception handlers, severity + cooldown gated ([runbook](docs/operations/error-notifications.md))
