...
FOUNDATION=$(echo "$CHANGED" | grep -E '^(src/_core/|src/_apps/|pyproject\.toml$|\.pre-commit-config\.yaml$|CLAUDE\.md$|\.serena/memories/|\.claude/skills/_shared/|\.claude/hooks/|\.claude/settings\.json$)' || true)
