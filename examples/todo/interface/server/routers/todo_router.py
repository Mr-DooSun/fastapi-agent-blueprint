...
@inject
async def get_todo(id: int, todo_service: TodoService = Depends(Provide[TodoContainer.todo_service])) -> SuccessResponse[TodoResponse]:
...
@inject
async def update_todo(id: int, item: UpdateTodoRequest, todo_service: TodoService = Depends(Provide[TodoContainer.todo_service])) -> SuccessResponse[TodoResponse]:
...
@inject
async def delete_todo(id: int, todo_service: TodoService = Depends(Provide[TodoContainer.todo_service])) -> SuccessResponse:
